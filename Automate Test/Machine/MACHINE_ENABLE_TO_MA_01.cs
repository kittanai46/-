...
{
    [TestFixture]
    public class MACHINE_ENABLE_TO_MA_01
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            Thread.Sleep(3000);
            var Enable = driver.FindElement(By.XPath("//*[@id=\"setMachineStatusMaBtn\"]/span"));
            Enable.Click();

            var confirm = driver.FindElement(By.XPath("/html/body/div[3]/div[3]/div/button[2]"));
            confirm.Click();
