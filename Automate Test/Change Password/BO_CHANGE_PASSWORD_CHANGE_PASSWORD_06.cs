...
{
    [TestFixture]
    public class BO_CHANGE_PASSWORD_CHANGE_PASSWORD_06
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            inputUser.SendKeys("nopmontolPN");
            inputPassword.SendKeys("vtm@Promptnow2025");
            loginButton.Click();
            ...
            old_pass.SendKeys("vtm@Promptnow2025");

            new_pass.SendKeys("vtmPromptnow2026");

            new2_pass.SendKeys("vtmPromptnow2026");
