...
{
    [TestFixture]
    public class BO_PERMISSION_EDIT_02
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            var view = driver.FindElement(By.XPath("//*[@id="search"]/tbody/tr[3]/td[2]/table/tbody/tr[1]/td[2]/ul[1]/li[1]/input"));
            view.Click();
