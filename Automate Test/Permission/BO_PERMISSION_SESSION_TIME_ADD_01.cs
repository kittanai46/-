...
{
    [TestFixture]
    public class BO_PERMISSION_SESSION_TIME_ADD_01
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            var Edit = driver.FindElement(By.XPath("//*[@id=\"search\"]/tbody/tr[3]/td[2]/table/tbody/tr[29]/td[2]/ul[2]/li[1]/input"));
            Edit.Click();
            Thread.Sleep(2000); // Optional delay to ensure smooth scrolling
            var View = driver.FindElement(By.XPath("//*[@id=\"search\"]/tbody/tr[3]/td[2]/table/tbody/tr[29]/td[2]/ul[2]/li[2]/input"));
            View.Click();
            Thread.Sleep(2000); // Optional delay to ensure smooth scrolling
