...
{
    [TestFixture]
    public class BO_VULCAN_MASTER_CONFIGURATION_SEARCH_01
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            var Vulcan_Master_Configuration = driver.FindElement(By.XPath("//*[@id=\"ui-id-1\"]"));
            Vulcan_Master_Configuration.Click();


            var searchbutton = driver.FindElement(By.XPath("//*[@id=\"searchbutton\"]"));
            searchbutton.Click();

            //var View = driver.FindElement(By.XPath("//*[@id=\"data_grid\"]/fieldset/div[1]/table/tbody/tr[1]/td[12]/a"));
            //View.Click();
