...
{
    [TestFixture]
    public class SLIP_CONTENT_PATCH_MANAGEMENT_TIME_OUT_01
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            // รอ Element ของ VIEW ปรากฏ
            var VIEW = wait.Until(d => d.FindElement(By.XPath("//*[@id=\"frmUser1\"]/div[5]/div/div/fieldset/div/table/tbody/tr/td[8]/a[2]")));
            VIEW.Click();
