...
{
    [TestFixture]
    public class VDO_CONTENT_PATCH_MANAGEMENT_TIME_OUT_01
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            var view = driver.FindElement(By.XPath("//*[@id=\"frmUser1\"]/div[5]/div/div/fieldset/div/table/tbody/tr/td[8]/a[2]"));
            view.Click();
