...
{
    [TestFixture]
    public class BO_CHANGE_PASSWORD_CHANGE_PASSWORD_04
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            Console.WriteLine("Page refreshed by pressing F5 after 15 minutes.");

            // รอให้หน้าเว็บโหลดใหม่หลังจากกด F5 (สามารถปรับเพิ่มเวลาตามความจำเป็น)
            Thread.Sleep(5000); // รอ 5 วินาทีเพื่อให้หน้าโหลดใหม่

            // Locate the save button after page refresh and click it
