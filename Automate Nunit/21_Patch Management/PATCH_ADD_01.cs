...
namespace SeleniumWebBrowser
{
    ...
    public class PATCH_ADD_01
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            Thread.Sleep(2000);
            var add = driver.FindElement(By.XPath("//*[@id=\"doAdd\"]/span"));
            add.Click();

            var pathset = driver.FindElement(By.XPath("//*[@id=\"patchsetcode\"]"));
            pathset.SendKeys("123_SYSTEM_1234");
