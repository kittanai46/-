...
{
    [TestFixture]
    public class B0_ADMIN_USER_RESET_PASSWORD_02
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            var reset = driver.FindElement(By.XPath("//*[@id=\"frmUser1\"]/div[5]/div/div/fieldset/div/table/tbody/tr[1]/td[14]/a[3]/span"));
            if (reset.Displayed) { 
            reset.Click();
            }
            

            var ok = driver.FindElement(By.XPath("/html/body/div[3]/div[3]/div/button[1]/span"));
            ok.Click();
