...
{
    [TestFixture]
    public class BO_ACTION_PROFILE_VIEW_03
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            name.SendKeys("Muhaha");

            var search = driver.FindElement(By.XPath("//*[@id=\"SearchBtn\"]"));
            search.Click();

            Thread.Sleep(3000);
            var view = driver.FindElement(By.XPath("//*[@id=\"frmUser1\"]/div[5]/div/div/fieldset/div[1]/table/tbody/tr[1]/td[6]/a[2]/span"));
            view.Click();
        }
