...
{
    [TestFixture]
    public class STATUS_ACTION_ALERT_MESSAGE_ADD_01
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            Thread.Sleep(2000);
            var name = driver.FindElement(By.XPath("//*[@id=\"statusactionname\"]"));
            name.SendKeys("Test name ");

            var description = driver.FindElement(By.XPath("//*[@id=\"statusactiondescription\"]"));
            description.SendKeys("Test Hello 1234");

            Thread.Sleep(3000);
            var remark = driver.FindElement(By.XPath("//*[@id=\"statusactionremark\"]"));
            remark.SendKeys("Hello this is a messege");
            ...
            var shortm = driver.FindElement(By.XPath("//*[@id=\"shortmessage\"]"));
            shortm.SendKeys("Hello");

            var message = driver.FindElement(By.XPath("//*[@id=\"messageval\"]"));
            message.SendKeys("Hello");

            Thread.Sleep(2500);

            var save = driver.FindElement(By.XPath("//*[@id=\"addBtn\"]"));
            save.Click();   
