...
{
    [TestFixture]
    public class BO_SYSTEM_LOG_SESSION_TIME_OUT_02
    {
        ...
        public void TestLoginWithIncorrectCredentials()
        {
            ...
            var Log = driver.FindElement(By.XPath("//*[@id=\"myslidemenu\"]/ul/li[2]/a"));
            Log.Click();

            Thread.Sleep(2000);

            var System_Log = driver.FindElement(By.XPath("//*[@id=\"ui-id-1\"]"));
            System_Log.Click();


            Thread.Sleep(900000);

            // กดปุ่ม F5 เพื่อรีเฟรชหน้าเว็บ
